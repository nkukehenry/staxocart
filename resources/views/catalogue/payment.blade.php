...
@section('content')
    ...
    <div class="row justify-content-center">
            <div class="card col-6 mt-2 mb-2 p-4"> 
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('orders.pay') }}" method="post" class="require-validation"
                        ...
                        <div class='row mt-2'>
                            <div class='col-12 form-group card-no required'>
                        ...
                        <div class="row  mt-2">
                            <div class="col-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ( {{ $order->order_total }})</button>
                            </div>
                        </div>
